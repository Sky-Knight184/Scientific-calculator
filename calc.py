...
def basic_operations():
    ...
    print("11. Scientific Logarithm(1)")
    print("12. Natural Logarithm(1)")
    print("13. Exponential Function(1)")
    print("14. Convert to Scientific Notation(1)")
    ...
    print("27. e to the Power(1)")
    print("28. Number Inverse (1/x)(1)")
    print("29. Simple Interest(0)")
    print("30. Compound Interest(0)")
...
# understand the function here (important)
        result = "{:.3e}".format(num1)
        stack.append(result)
    elif choice == '15':
        result = float(input("Enter number in scientific notation (e.g., 2.5e3): "))
        print(result)
        stack.append(result)
    elif choice == '16':
...
# understand the function here (important)
        ...
        result = f"{whole} {numerator}/{fraction.denominator}"
        stack.append(result)
    elif choice == '27':
        result = math.exp(num1)
        stack.append(result)
